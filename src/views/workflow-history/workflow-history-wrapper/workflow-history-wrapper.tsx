import useSuspenseIsWorkflowHistoryV2Enabled from '@/views/workflow-history-v2/hooks/use-suspense-is-workflow-history-v2-enabled';
...
export default function WorkflowHistoryWrapper(props: Props) {
  const isWorkflowHistoryV2Enabled = useSuspenseIsWorkflowHistoryV2Enabled();
