 ...
 *
 * Returns an empty string for an empty selection (callers should guard against
 * submitting an empty selection before calling this).
 */
export default function buildSelectionQuery(
  workflows: ReadonlyArray<Pick<DomainWorkflow, 'workflowID' | 'runID'>>
): string {
  return workflows
