...
import { cssStyles, overrides } from './schedule-page-details-section-header.styles';
import { type Props } from './schedule-page-details-section-header.types';

export default function SchedulePageDetailsSectionHeader({
  title,
  isCollapsed,
  onToggle,
}: Props) {
