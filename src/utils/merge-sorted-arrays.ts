 ...
 *   - If the function returns a positive number (> 0), the second argument is considered the higher-priority candidate.
 *   - If the function returns a negative number (<= 0), the first argument is considered the higher-priority candidate.
 *   - The comparison logic must align with the sorting logic of the input arrays to maintain consistency.
