...
const mockSchedules = [
  getMockScheduleListEntry({ scheduleId: 'mock-schedule-id-1', workflowType: { name: 'mock-workflow-type-1' } }),
  getMockScheduleListEntry({ scheduleId: 'mock-schedule-id-2', workflowType: { name: 'mock-workflow-type-2' }, state: { paused: true, pauseInfo: null }, cronExpression: '*/5 * * * *' }),
];
